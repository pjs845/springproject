...
public class AddressRestController { //CRUD
	...
	public void create(Address address) { //파라미터를 jsObj로 받을 때
		//Address test = new Address(-1, "마동석", "서울시", null);
	...
	//http://127.0.0.1:8080/rest_addr/create1.json?name=서인&addr=대전
	//http://127.0.0.1:8080/rest_addr/create1?name=가1&addr=나1
	//http://127.0.0.1:8080/rest_addr/create1.xml?name=가2&addr=나2
	//http://127.0.0.1:8080/rest_addr/create1.json?name=가3&addr=나3
	...
	//http://127.0.0.1:8080/rest_addr/create2.json 또는 create2.xml 또는 create2
	...
	//아래의 방법도 가능은 하지만 @GetMapping("read/{seq}")와 공존불가!
	/*@GetMapping("read/{na}")
