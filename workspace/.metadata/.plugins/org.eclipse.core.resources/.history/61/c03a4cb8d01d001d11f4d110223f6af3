...
import pjs.ct.domain.Human;
import pjs.ct.domain.HumanList;
import pjs.ct.domain.Todo;
...
public class TestController {
   ...
   public void m11(@RequestParam("dump") String cla, int grade, Human dto) {
